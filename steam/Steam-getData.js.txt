...
(function() {
    ...
    // Your code here...
    //INIT
    if (document.location.href == "https://store.steampowered.com/search?category1=998&page=0") {
    ...
    (function () {
        ...
        if ( parseInt(localStorage.getItem("lastPage")) > parseInt(localStorage.getItem("pageNum"))) {
            document.location.href = "https://store.steampowered.com/search?category1=998&page=" + localStorage.getItem("pageNum");
        } else {
            //OUTPUT
