...
var prefix = {738484352568262747 : "-"};				// default prefix
...
const replychance_filtername = log_var("Reply Chance on/off filename", "autoreply_toggle.txt");
...
function read_file(channel_file, intervals, allow_non_int=false, sep="", remove_dupes=false) {
	try {
...
bot.on("ready", () => {
	...
	bot.user.setActivity(prefix[msg.guild.id]+"help | JaredBot");
});
...
bot.on("message", msg => {
	if (msg.content == prefix[msg.guild.id]+"help" || msg.content == prefix[msg.guild.id]+"commands") {
		...
		help_embed.addFields(
			{name: "Tools", value: "`-help tools`", inline: true},
			{name: "Info", value: "`-help info`", inline: true},
			{name: "Chat", value: "`-help chat`", inline: true},
			{name: "Image", value: "`-help img`", inline: true},
			{name: "Games", value: "`-help games`", inline: true},
			{name: "Maths", value: "`-help maths`", inline: true},
			{name: "Admin/Mod", value: "`-help mod`", inline: true},
...
bot.on("message", msg => {
	try {
		if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
			if (msg.content.slice(0, 6) === prefix[msg.guild.id]+"help " ||
			...
			if (module_name == "tools" || msg.content == prefix[msg.guild.id]+"tools") {
				...
				help_module_embed.addFields (
					...
					{name: "-network", value: "`-help network`", inline: true},
					{name: "\n\u200B", value: "\n\u200B", inline: true},
				)
			...
			// Info
				...
				help_module_embed.addFields (
					...
					{name: "-table or -periodictable", value: "`-help table`\n\u200B", inline: true},
			...
			// Info
				...
				embed_help_reply(msg, {name: "-table or -periodictable", value: "displays a photo of the periodic table, you can use this command for example to get the number of an element, and then use the `-element` command to get more info on that element.\n\u200B"});
			...
			// Admin/Mod
				...
				automod_help(msg);
			} else if (msg.content == prefix[msg.guild.id]+"autonude" || msg.content == prefix[msg.guild.id]+"autophoto" || msg.content == prefix[msg.guild.id]+"autopost" ||
			...
			// network
			} else if (msg.content == prefix[msg.guild.id]+"ping" || msg.content == prefix[msg.guild.id]+"nslookup" || msg.content == prefix[msg.guild.id]+"tracert" || 
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 7) == prefix[msg.guild.id]+"fancy") {
			help_fancy(msg);
			
		} else if (msg.content.slice(0, 7) == prefix[msg.guild.id]+"fancy ") {
		...
		} else if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"flip ") {
		...
		} else if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"tiny ") {
		...
		} else if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"clap ") {
			msg_channel_send(msg, (" "+msg.content.slice(6, msg.content.length)).split(" ").join("👏"));
			
		} else if (msg.content.slice(0, 7) == prefix[msg.guild.id]+"width ") {
			msg_channel_send(msg, msg.content.slice(7, msg.content.length).split("").join("   "));
			
		} else if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"wide ") {
			msg_channel_send(msg, msg.content.slice(6, msg.content.length).split("").join("   "));
			
		} else if (msg.content.slice(0, 8) == prefix[msg.guild.id]+"wiggle " || msg.content.slice(0, 6) == prefix[msg.guild.id]+"worm " ||
		...
		} else if (msg.content.slice(0, 7) == prefix[msg.guild.id]+"alter ") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"tos") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"rules") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0,6) == prefix[msg.guild.id]+"rule ") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"letteremoji on") {
		...
		} else if (msg.content == prefix[msg.guild.id]+"letteremoji off") {
			if (msg.member.hasPermission("MANAGE_MESSAGES") == true) {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 11) == prefix[msg.guild.id]+"reportbug " || msg.content.slice(0, 5) == prefix[msg.guild.id]+"bug "
...
// self roles
bot.on("message", msg => {
	if (msg.content == prefix[msg.guild.id]+"selfroles") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"time " || msg.content.slice(0, 10) == prefix[msg.guild.id]+"timezone ") {
			is_US_state = false;
			
			// get city
			if (msg.content.slice(0, 10) == prefix[msg.guild.id]+"timezone ") {
...
bot.on("message", msg=> {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0,5).toLowerCase() === prefix[msg.guild.id]+"say " || msg.content.slice(0, 8) == prefix[msg.guild.id]+"repeat ") {
			embed_say = new Discord.MessageEmbed();
			embed_say.setColor(embed_color_chat);
			if (msg.content.slice(0, 5) == prefix[msg.guild.id]+"say ") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0,8).toLowerCase() === prefix[msg.guild.id]+"do you " || msg.content.slice(0,6) === prefix[msg.guild.id]+"do u ") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0,4).toLowerCase() == prefix[msg.guild.id]+"is ") {
			embed_chat_reply(msg, ["Yes", "No"][parseInt(Math.random() * 100) % 2]);
		}
	}
})
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0,8).toLowerCase() == prefix[msg.guild.id]+"should ") {
			embed_chat_reply(msg, ["Yes", "No"][parseInt(Math.random() * 100) % 2]);
		}
	}
})
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0,8).toLowerCase() === prefix[msg.guild.id]+"howgay " || msg.content === prefix[msg.guild.id]+"howgay") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0,6).toLowerCase() === prefix[msg.guild.id]+"will ") {
			embed_chat_reply(msg, ["Yes", "No"][parseInt(Math.random() * 100) % 2]);
		}
	}
})
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 7) == prefix[msg.guild.id]+"8ball ") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 5) == prefix[msg.guild.id]+"boob" || msg.content.slice(0, 5) == prefix[msg.guild.id]+"nsfw" || msg.content.slice(0, 5) == prefix[msg.guild.id]+"tity" ||
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 4) == prefix[msg.guild.id]+"ass" || msg.content.slice(0, 8) == prefix[msg.guild.id]+"asshole" || msg.content.slice(0, 4) == prefix[msg.guild.id]+"but") {
			if (msg.channel.nsfw == true) {
				// send message
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"pussy" || msg.content.slice(0, 7) == prefix[msg.guild.id]+"vagina" || msg.content.slice(0, 6) == prefix[msg.guild.id]+"fanny" ||
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"anal") {
			if (msg.channel.nsfw == true) {
				// send message
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 8) == prefix[msg.guild.id]+"blowjob" || msg.content.slice(0, 3) == prefix[msg.guild.id]+"bj" || 
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 7) == prefix[msg.guild.id]+"finger" || msg.content.slice(0, 6) == prefix[msg.guild.id]+"touch") {
			if (msg.channel.nsfw == true) {
				// send message
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 5) == prefix[msg.guild.id]+"porn" || msg.content.slice(0, 8) == prefix[msg.guild.id]+"porngif") {
			if (msg.channel.nsfw == true) {
				// send message
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.author.bot == false) {
			// dick
			if (msg.content == prefix[msg.guild.id]+"dick" || msg.content == prefix[msg.guild.id]+"milf" || msg.content == prefix[msg.guild.id]+"theesome" || 
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 5) == prefix[msg.guild.id]+"owo ") {
...
// hug
bot.on("message", msg => {
	if (msg.content.slice(0, 4) == prefix[msg.guild.id]+"hug") {
		...
		} else if (msg.content == prefix[msg.guild.id]+"hug") {
...
// kiss
bot.on("message", msg => {
	if (msg.content.slice(0, 5) == prefix[msg.guild.id]+"kiss") {
		let member = msg.mentions.members.first();
		if (member != undefined) {
			user_receiver = member.user.tag.split("#")[0];
			user_sender = msg.member.user.tag.split("#")[0];
		...
		} else if (msg.content == prefix[msg.guild.id]+"kiss") {
...
function configure_autopost(msg, commands, description, intervals, channel_file, webserver_dataset, database_count, nsfw=true) {
	try {
		if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
			if (msg.content.slice(0, commands.length+1) == prefix[msg.guild.id]+commands) {
...
bot.on("message", msg => {
	if (msg.content.slice(0, 12) == prefix[msg.guild.id]+"autohentai ") {
...
bot.on("message", msg => {
	if (msg.content.slice(0, 10) == prefix[msg.guild.id]+"autonude ") {
...
bot.on("message", msg => {
	if (msg.content.slice(0, 10) == prefix[msg.guild.id]+"automeme ") {
...
bot.on("message", msg => {
	if (msg.content.slice(0, 11) == prefix[msg.guild.id]+"autophoto ") {
...
bot.on("message", msg => {
	if (msg.content.slice(0, 10) == prefix[msg.guild.id]+"autobird ") {
...
bot.on("message", msg => {
	if (msg.content.slice(0, 9) == prefix[msg.guild.id]+"autocar ") {
...
bot.on("message", msg => {
	if (msg.content.slice(0, 9) == prefix[msg.guild.id]+"autocat ") {
...
bot.on("message", msg => {
	if (msg.content.slice(0, 9) == prefix[msg.guild.id]+"autodog ") {
...
bot.on("message", msg => {
	if (msg.content.slice(0, 11) == prefix[msg.guild.id]+"autosnake ") {
...
bot.on("message", msg => {
	if (msg.content.slice(0, 13) == prefix[msg.guild.id]+"autoporngif ") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0,9) === prefix[msg.guild.id]+"execute ") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 8) == prefix[msg.guild.id]+"choose " || msg.content.slice(0, 8) == prefix[msg.guild.id]+"choice ") {
...
// anouncment
bot.on("message", msg => {
	if (msg.content.toLowerCase().slice(0,10) === prefix[msg.guild.id]+"announce ") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 5) === prefix[msg.guild.id]+"bot ") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"cat" || msg.content == prefix[msg.guild.id]+"meow") {
			// send message
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"dog" || msg.content == prefix[msg.guild.id]+"woof") {
			// send message
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 5) == prefix[msg.guild.id]+"heli" || msg.content.slice(0, 6) == prefix[msg.guild.id]+"chpper") {
			// send message
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 8) == prefix[msg.guild.id]+"dogmeme") {
			// send message
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 5) == prefix[msg.guild.id]+"nude") {
			if (msg.channel.nsfw == true) {
				// send message
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 4) == prefix[msg.guild.id]+"car") {
			// send message
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"snake") {
			// send message
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 5) == prefix[msg.guild.id]+"bird") {
			// send message
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 7) == prefix[msg.guild.id]+"racoon") {
			// send message
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 7) == prefix[msg.guild.id]+"photo") {
			// send message
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 7) == prefix[msg.guild.id]+"avatar") {
			let member = msg.mentions.members.first();
...
bot.on("message", msg => {
	if (msg.content.toLowerCase() === prefix[msg.guild.id]+"invitelink") {
		embed_chat_reply_header(msg, perm_invite_link, "Jared Network Invite Link", pfp=false);
	}
})

bot.on("message", msg => {
	if (msg.content == prefix[msg.guild.id]+"invitebot" || msg.content == prefix[msg.guild.id]+"addbot" || msg.content == prefix[msg.guild.id]+"botinvite") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"invite") {
...
bot.on("message", msg => {
	if (msg.content === prefix[msg.guild.id]+"author") {
...
bot.on("message", msg => {
	if (msg.content.slice(0, 4) == prefix[msg.guild.id]+"web") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"servercount") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.toLowerCase() == prefix[msg.guild.id]+"stop") {
			...
			create_file_then_append_data(msg, replychance_filtername, "false", endl="\n", overwrite=true);
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.toLowerCase() == prefix[msg.guild.id]+"autoresponse") {
			...
			create_file_then_append_data(msg, replychance_filtername, "true", endl="\n", overwrite=true);
...
bot.on("ready", msg => {
	// load replychance
	read_file(replychance_filtername, DoAutoReply, allow_non_int=true, sep="", remove_dupes=false);
	setTimeout(function(){
		console_log(DoAutoReply);
	}, 8000);
})
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"font ") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"justone start") {
			// start game
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"justone join") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"justone ready") {
			if (msg.member.hasPermission("MANAGE_MESSAGES") == true) {
				// choose word
				//words_dataset
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"justone endgame") {
			// clear files
...
bot.on("message", msg => {
	if (msg.channel.type == "dm") {
		if (msg.content.slice(0, 15) == prefix[msg.guild.id]+"justone clues ") {
		...
		if (msg.content.toLowerCase().slice(0, 10) == prefix[msg.guild.id]+"remind me") {
			try {
				if (msg.content.toLowerCase().indexOf(" second") > -1) {
					...
					reminder = msg.content.toLowerCase().replace(prefix[msg.guild.id]+"remind me ","")
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"uptime") {
...
bot.on("message", msg => {
	if (msg.content == prefix[msg.guild.id]+"ttt") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"flipcoin") {
	...
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.toLowerCase().slice(0, 11) == prefix[msg.guild.id]+"steaminfo ") {
			fs_write.writeFile(inputs_file_steaminfo, "get-steam-info " + msg.content.slice(11, msg.content.length), function(err) {
				if (err) {
					return console_log("Failed to write get-steam-info command to file!", error=true);
				}
				console_log("wrote command get-steam-info to file!");
			})
			...
			setTimeout(function(){
				fs_read.readFile(output_file_steaminfo, "utf-8", function(err, data) {
					if (err) {
						return console_log("Failed to read steam info output file!", error=true);
					}
					...
					embed_steamdata.setThumbnail(webserver_root_address+"img/src/steam_icon1.png");
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 4) == prefix[msg.guild.id]+"sl ") {
			...
			if (isInt_without_error(current_user_id, 0, 10**20) == true) {
				// get html
				request(sl_url +current_user_id, {
					headers: {
					...
					if (res.statusCode == 200) {
						...
						try {
							player_name = html.split('<div class="long-name" itemprop="name">')[1].split("</div>")[0];
						} catch {player_name = "?"} try {
							Avatar_URL = html.split('<div class="profile-header">')[1].split('class="steam-avatar">')[0].split('<img itemprop="image" src="')[1].replace(/[ \n]/g, "");
						} catch {Avatar_URL = "?"} try {
							Custom_ID = html.split('<th scope="row">Steam ID</th>')[1].split("</td>")[0].split(">")[1].replace(/[ \n]/g, "");
						} catch {Custom_ID = "?"} try {
							Reputation = html.split('<th scope="row">Reputation</th>')[1].split("</td>")[0].split(">")[1].replace(/[ \n]/g, "");
						} catch {Reputation = "?"} try {
							Public = html.split('<i class="material-icons')[1].split("</i>")[0].replace(/[ \n]/g, "");
						} catch {Public = "?"} try {
							Country = html.split('<th scope="row">Country</th>')[1].split("</a>")[0].split('">')[1].replace(/[ \n]/g, "");
						} catch {Country = "?"} try {
							Years = html.split('<th scope="row">Steam years ')[1].split("</td>")[0].split("<td>")[1].replace(/[ \n]/g, "");
						} catch {Years = "?"} try {
							Donator = html.split('<th scope="row">Donator</th>')[1].split("</i>")[0].split('">')[1].replace(/[ \n]/g, "");
						} catch {Donator = "?"} try {
							Friends = html.split('<th scope="row">Friends</th>')[1].split("</a>")[0].split('">')[1].replace(/[ \n]/g, "");
						} catch {Friends = "?"}
						
						// level stats
						try {
							Est_cost = html.split('<h5>Level stats</h5>')[1].split("</td>")[0].split('<td>')[1].replace(/[ \n]/g, "");
						} catch {Est_cost = "?"} try {
							Next_lvl_cost = html.split('<th scope="row">Next Level Cost ')[1].split("</a>")[0].split('blank">')[1].replace(/[ \n]/g, "");
						} catch {Next_lvl_cost = "?"} try {
							world_lvl = html.split('<th scope="row">World Rank</th>')[1].split("</a>")[0].split('xp/">')[1].replace(/[ \n]/g, "");
						} catch {world_lvl = "?"} try {
							region_lvl = html.split('<th scope="row">Region Rank</th>')[1].split("</span>")[0].split('/">')[1].replace(/[ \n]/g, "").replace('</a><spanclass="percentage">'," ") + ")";
						} catch {region_lvl = "?"} try {
							country_lvl = html.split('<th scope="row">Country Rank</th>')[1].split("</span>")[0].split('/">')[1].replace(/[ \n]/g, "").replace('</a><spanclass="percentage">'," ") + ")";
						} catch {country_lvl = "?"} try {
							best_lvl = html.split('<div class="long">World</div>')[1].split("</td>")[0].split('<td>')[1].replace(/[ \n]/g, "").replace('</a><spanclass="percentage">'," ");
						} catch {best_lvl = "?"}
						
						// playtime stats
						try {
							playtime = html.split('<th scope="row">Total Playtime</th>')[1].split("</td>")[0].split('<td>')[1].replace(/[ \n]/g, "").replace("hours", " hours");
						} catch {playtime = "?"} try {
							avg_playtime = html.split('<th scope="row">Avg. Playtime ')[1].split("</td>")[0].split('<td>')[1].replace(/[ \n]/g, "").replace("min", " min");
						} catch {avg_playtime = "?"} try {
							world_playtime = html.split("<h5>Playtime stats</h5>")[1].split('<th scope="row">World Rank</th>')[1].split("</td>")[0].split('/">')[1].replace(/[ \n]/g, "").replace('</a><spanclass="percentage">'," ").replace("</span>","");
						} catch {world_playtime = "?"} try {
							region_playtime = html.split("<h5>Playtime stats</h5>")[1].split('<th scope="row">Region Rank</th>')[1].split("</td>")[0].split('/">')[1].replace(/[ \n]/g, "").replace('</a><spanclass="percentage">'," ").replace("</span>","");
						} catch {region_playtime = "?"} try {
							country_playtime = html.split("<h5>Playtime stats</h5>")[1].split('<th scope="row">Country Rank</th>')[1].split("</td>")[0].split('/">')[1].replace(/[ \n]/g, "").replace('</a><spanclass="percentage">'," ").replace("</span>","");
						} catch {country_playtime = "?"} try {
							best_playtime = html.split("<h5>Playtime stats</h5>")[1].split('<div class="long">World</div>')[1].split("</td>")[0].split('<td>')[1].replace(/[ \n]/g, "");
						} catch {best_playtime = "?"}
						
						// game stats
						try {
							game_badge = game_badge_url + html.split('src="'+game_badge_url)[1].split(">")[0];
						} catch {game_badge = "?"} try {
							games_owned = html.split('class="game-text-stats"')[1].split("</div>")[0].replace(/[ \n>]/g, "").replace("Games"," Games");
						} catch {games_owned = "?"} try {
							Est_game_cost = html.split('<h5>Games stats</h5>')[1].split('<th scope="row">Estimated Cost ')[1].split("</td>")[0].split('<td>')[1].replace(/[ \n]/g, "");
						} catch {Est_game_cost = "?"} try {
							world_games = html.split("<h5>Games stats</h5>")[1].split('<th scope="row">World Rank</th>')[1].split("</td>")[0].split('/">')[1].replace(/[ \n]/g, "").replace('</a><spanclass="percentage">'," ").replace("</span>","");
						} catch {world_games = "?"} try {
							region_games = html.split("<h5>Games stats</h5>")[1].split('<th scope="row">Region Rank</th>')[1].split("</td>")[0].split('/">')[1].replace(/[ \n]/g, "").replace('</a><spanclass="percentage">'," ").replace("</span>","");
						} catch {region_games = "?"} try {
							country_games = html.split("<h5>Games stats</h5>")[1].split('<th scope="row">Country Rank</th>')[1].split("</td>")[0].split('/">')[1].replace(/[ \n]/g, "").replace('</a><spanclass="percentage">'," ").replace("</span>","");
						} catch {country_games = "?"} try {
							best_games = html.split("<h5>Games stats</h5>")[1].split('<div class="long">World</div>')[1].split("</td>")[0].split('<td>')[1].replace(/[ \n]/g, "");
						} catch {best_games = "?"}
						...
						console_log("Steam Ladder responded with HTTP status code " + res.statusCode + "!", error=true);
					}
				})
			} else {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 8) == prefix[msg.guild.id]+"prefix ") {
			if (authorised_IDs.indexOf(msg.author.id) > -1) {
				...
				embed_error(msg, "Currently only Jared can change the bots prefix, but i am working on a feature where admins can change the bots prefix on a per server basis!");
			}
		}
	}
})
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"prefix") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 9) == prefix[msg.guild.id]+"userinfo") {
			let member = msg.mentions.members.first();
			if (member != undefined) {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"serverinfo") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 9) == prefix[msg.guild.id]+"roleinfo") {
			// get role ID
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"ping ") {
			execute_cmd(msg, "Ping", msg.content);
		} else if (msg.content.slice(0, 10) == prefix[msg.guild.id]+"nslookup ") {
			execute_cmd(msg, "Nslookup", msg.content);
		} else if (msg.content.slice(0, 9) == prefix[msg.guild.id]+"tracert ") {
			execute_cmd(msg, "Tracert", msg.content);
		} else if (msg.content.slice(0, 10) == prefix[msg.guild.id]+"pathping ") {
			execute_cmd(msg, "Pathping", msg.content);
		} else if (msg.content.slice(0, 9) == prefix[msg.guild.id]+"ipconfig") {
			if (authorised_IDs.indexOf(msg.author.id) > -1) {
		...
		} else if (msg.content.slice(0, 7) == prefix[msg.guild.id]+"whois ") {
			execute_cmd(msg, "Whois", msg.content);
		} else if (msg.content == prefix[msg.guild.id]+"speedtest") {
			execute_cmd(msg, "Speedtest", msg.content);
		} else if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"echo ") {
			execute_cmd(msg, "Echo", msg.content);
		} else if (msg.content.slice(0, 7) == prefix[msg.guild.id]+"geoip ") {
			geoip_lookup(msg);
		}
	}
})
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"port ") {
...
bot.on("message", msg => {
	if (msg.content.slice(0, 5) == prefix[msg.guild.id]+"perm") {
		if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
			let member = msg.mentions.members.first();
			if (member != undefined) {
				message = member;
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"warn ") {
			if (msg.member.hasPermission("MANAGE_MESSAGES") == true) {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 5) == prefix[msg.guild.id]+"mute") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 7) == prefix[msg.guild.id]+"unmute") {
			if (msg.member.hasPermission("MUTE_MEMBERS") == true) {
				let member = msg.mentions.members.first();
				if (member != undefined) {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 9) == prefix[msg.guild.id]+"tempmute") {
			if (msg.member.hasPermission("MUTE_MEMBERS") == true) {
				let member = msg.mentions.members.first();
				if (member != undefined) {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 5) == prefix[msg.guild.id]+"kick") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 4) == prefix[msg.guild.id]+"ban" && msg.content.slice(0, 9) != prefix[msg.guild.id]+"banemoji" && msg.content.slice(0, 7) != prefix[msg.guild.id]+"banurl") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 8) == prefix[msg.guild.id]+"tempban") {
			if (msg.member.hasPermission("BAN_MEMBERS") == true) {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"unban" && msg.content.slice(0, 11) != prefix[msg.guild.id]+"unbanemoji") {
			if (msg.member.hasPermission("BAN_MEMBERS") == true) {
				if (msg.guild.me.hasPermission("BAN_MEMBERS") == true) {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 10) == prefix[msg.guild.id]+"invisible") {
			if (msg.member.hasPermission("MUTE_MEMBERS") == true) {
				let member = msg.mentions.members.first();
				if (member != undefined) {
					if (member.hasPermission("MUTE_MEMBERS") == false) {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 8) == prefix[msg.guild.id]+"visible") {
			if (msg.member.hasPermission("MUTE_MEMBERS") == true) {
				if (msg.guild.me.hasPermission("MANAGE_ROLES") == true) {
					let member = msg.mentions.members.first();
					if (member != undefined) {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 9) == prefix[msg.guild.id]+"logging ") {
			if (authorised_IDs.indexOf(msg.author.id) > -1) {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"snipe") {
			if (authorised_IDs.indexOf(msg.author.id) > -1) {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0,10) == prefix[msg.guild.id]+"snipping ") {
			if (authorised_IDs.indexOf(msg.author.id) > -1) {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"clearlog") {
			if (authorised_IDs.indexOf(msg.author.id) > -1) {
				// clear deleted messages log
				var current_time = new Date();
				fs_write.writeFile(deleted_messages_log_file, "Log File cleared on " + String(current_time) + "\n", function(err) {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		// show help menu
		if (msg.content == prefix[msg.guild.id]+"purge") {
			help_clear(msg);
			return;
		}
		
		// do clear
		if (msg.content.slice(0, 7) == prefix[msg.guild.id]+"purge " || msg.content.slice(0, 7) == prefix[msg.guild.id]+"clear ") {
			if (msg.content != prefix[msg.guild.id]+"clearlog") {
				if (msg.member.hasPermission("MANAGE_MESSAGES") == true) {
					...
					if (isNaN(parseInt(purge_num)) == false) {
						...
						if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"clear") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"automod" || msg.content == prefix[msg.guild.id]+"automod help") {
			automod_help(msg);
			
		} else if (msg.content == prefix[msg.guild.id]+"automod rules") {
			try {
				// get dir
		...
		} else if (msg.content.slice(0, 16) == prefix[msg.guild.id]+"automod remove ") {
			if (msg.member.hasPermission("MANAGE_CHANNELS") == true) {
		...
		} else if (msg.content.slice(0, 17) == prefix[msg.guild.id]+"automod warnlist") {
			// dir
		...
		} else if (msg.content.slice(0, 9) == prefix[msg.guild.id]+"automod ") {
			try {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"exit") {
			if (authorised_IDs.indexOf(msg.author.id) > -1) {
...
bot.on("message", msg => {
	if (msg.guild != null && filter_onoff[msg.guild.id] != undefined) {
		if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
			if (msg.content.slice(0, 10) == prefix[msg.guild.id]+"banemoji ") {
				if (msg.member.hasPermission("MANAGE_MESSAGES") == true) {
...
bot.on("message", msg => {
	if (msg.guild != null && filter_onoff[msg.guild.id] != undefined) {
		if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
			if (msg.content.slice(0, 12) == prefix[msg.guild.id]+"unbanemoji ") {
				if (msg.member.hasPermission("MANAGE_MESSAGES") == true) {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"emoji" || msg.content == prefix[msg.guild.id]+"banemoji" || msg.content == prefix[msg.guild.id]+"unbanemoji") {
			// embed
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.guild != null && filter_onoff[msg.guild.id] != undefined) {
			if (msg.content.slice(0, 8) == prefix[msg.guild.id]+"banurl ") {
				if (filter_onoff[msg.guild.id].indexOf("104") > -1 || filter_onoff[msg.guild.id].indexOf("199") > -1) {
					if (msg.member.hasPermission("MANAGE_MESSAGES") == true) {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 7) == prefix[msg.guild.id]+"filter") {
			if (msg.member.hasPermission("MANAGE_MESSAGES") == true) {
				...
				} else if (msg.content.slice(0, 15).toLowerCase() == prefix[msg.guild.id]+"filter on porn") {
					do_filter(msg, "101", "The porn links filter has been turned on!");
		
				} else if (msg.content.slice(0, 19).toLowerCase() == prefix[msg.guild.id]+"filter on phishing") {
					do_filter(msg, "102", "The phishing links filter has been turned on!");
		
				} else if (msg.content.slice(0, 15).toLowerCase() == prefix[msg.guild.id]+"filter on spam") {
					do_filter(msg, "103", "The spam filter has been turned on!");
		
				} else if (msg.content.slice(0, 20).toLowerCase() == prefix[msg.guild.id]+"filter on emojispam") {
					do_filter(msg, "104", "The emoji spam filter has been turned on!");
		
				} else if (msg.content.slice(0, 20).toLowerCase() == prefix[msg.guild.id]+"filter on promotion") {
					do_filter(msg, "105", "The promotions filter has been turned on!");
		
				} else if (msg.content.slice(0, 14).toLowerCase() == prefix[msg.guild.id]+"filter on tag") {
					do_filter(msg, "106", "The everyone and here tags filter has been turned on!");
		
				} else if (msg.content.slice(0, 14).toLowerCase() == prefix[msg.guild.id]+"filter on mod") {
					do_filter(msg, "107", "The asking to be mod filter has been turned on!");
		
				} else if (msg.content.slice(0, 19).toLowerCase() == prefix[msg.guild.id]+"filter on language") {
					do_filter(msg, "108", "The offensive language filter has been turned on!");
				} else if (msg.content == prefix[msg.guild.id]+"filter" || msg.content == prefix[msg.guild.id]+"filter help") {
					filter_help(msg);
				}
			} else {
...
bot.on("message", msg => {
	if (msg.author.id != bot_ID) {
		if (msg.content.slice(0,1) == prefix) {
			if (msg.content != prefix[msg.guild.id]+"authorise" && msg.content != prefix[msg.guild.id]+"help") {
...
bot.on("message", msg => {
	if (msg.content == prefix[msg.guild.id]+"authorise") {
...
/*bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 16) == prefix[msg.guild.id]+"changenickname " || msg.content.slice(0, 12) == prefix[msg.guild.id]+"changenick ") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"slowmode off") {
			msg.channel.setRateLimitPerUser("0");
			embed_chat_reply(msg, "slow mode has been turned off!");
			
		} else if (msg.content.slice(0, 10) == prefix[msg.guild.id]+"slowmode ") {
			if (msg.member.hasPermission("MANAGE_MESSAGES") == true) {
				command = msg.content.slice(10, msg.content.length);
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 7) == prefix[msg.guild.id]+"embed ") {
			...
			// send message
			msg_channel_send(msg, embed_custom);
			
		} else if (msg.content == prefix[msg.guild.id]+"embed") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0,11) == prefix[msg.guild.id]+"translate ") {
...
function hex_oct_bin(msg, base, base_name) {
	try {
		if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
			if (msg.content.slice(0,5) == prefix[msg.guild.id]+base_name+" ") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 5) == prefix[msg.guild.id]+"base") {
			...
			if (value.length == 2) {
				...
				embed_error(msg, "Invalid Format! correct format is `"+prefix[msg.guild.id]+"base{num1} {num2}` e.g. `"+prefix[msg.guild.id]+"base10 50`")
			}
		}
	}
})
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 9) == prefix[msg.guild.id]+"bin2int ") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 9) == prefix[msg.guild.id]+"oct2int ") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 9) == prefix[msg.guild.id]+"hex2int ") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 10) == prefix[msg.guild.id]+"bin2text ") {
			base2text(msg, "01", 2);
		}
	}
})
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 10) == prefix[msg.guild.id]+"oct2text ") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 10) == prefix[msg.guild.id]+"hex2text ") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 7) == prefix[msg.guild.id]+"roman ") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"pychallenge" || msg.content == prefix[msg.guild.id]+"py challenge") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"autopy" || msg.content == prefix[msg.guild.id]+"autopychallenge") {
			// embed
		...
		} else if (msg.content == prefix[msg.guild.id]+"autopychallenge on" || msg.content == prefix[msg.guild.id]+"autopy on") {
			// get directory
			auto_dir = msg.guild.name.replace(" ","_")+"_"+ msg.guild.id;
		...
		} else if (msg.content == prefix[msg.guild.id]+"autopychallenge off" || msg.content == prefix[msg.guild.id]+"autopy off") {
			// clear file
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 9) == prefix[msg.guild.id]+"element ") {
		...
		} else if (msg.content.slice(0, 9) == prefix[msg.guild.id]+"element") {
			embed_error(msg, "Invalid Format! the correct format is `-element {element No.}` or `-element {name}`, " +
			"For example `-element 94` will display information on Plutonium or `-element gold` will display information on Gold!");
		}
	}
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"periodictable" || msg.content == prefix[msg.guild.id]+"table") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 9) == prefix[msg.guild.id]+"pokemon ") {
		...
		} else if (msg.content == prefix[msg.guild.id]+"pokemon") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 10) == prefix[msg.guild.id]+"medicine ") {
		...
		} else if (msg.content == prefix[msg.guild.id]+"medicine") {
			// keys
			medicines_AZ = {};
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"music help" || msg.content == prefix[msg.guild.id]+"aliases") {
			// embed
			help_music(msg);
		}
	}
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		...
		if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"play " || msg.content.slice(0, 11) == prefix[msg.guild.id]+"forceplay " || 
			...
			// check for forceplay
			if (msg.content.slice(0, 11) == prefix[msg.guild.id]+"forceplay " || msg.content.slice(0, 10) == prefix[msg.guild.id]+"playskip ") {
				forceplay = true;
			} else {
				forceplay = false;
			}
					...
					// check if user is in same channel as bot
						...
						if (bot_channel.connection != null) {
							if (user_channel == bot_channel.connection.channel) {
								...
								// seek, forward, rewind
								if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"seek " || msg.content.slice(0, 9) == prefix[msg.guild.id]+"forward " || 
									...
									if (msg.content.slice(0, 8) == prefix[msg.guild.id]+"volume ") {
										// max volume
										song_length = 101;
									}
									...
									if (isInt(msg, seek_amount, 0, song_length, command_name, ErrorMessageEnd="") == true) {
										...
										if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"seek ") {
										...
										} else if (msg.content.slice(0, 9) == prefix[msg.guild.id]+"forward ") {
										...
										} else if (msg.content.slice(0, 8) == prefix[msg.guild.id]+"rewind ") {
										...
										} else if (msg.content.slice(0, 8) == prefix[msg.guild.id]+"volume ") {
			...
			if (msg.content == prefix[msg.guild.id]+"skip" || msg.content.slice(0, 7) == prefix[msg.guild.id]+"skipto" || msg.content == prefix[msg.guild.id]+"fs") {
				...
				if (msg.content == prefix[msg.guild.id]+"skip" || msg.content == prefix[msg.guild.id]+"fs") {
					// remove song from queue
					song_queus[msg.guild.id] = song_queus[msg.guild.id].slice(1, song_queus[msg.guild.id].length);
				
				// skipto {index} (skip to certain point in queue)
				} else if (msg.content == prefix[msg.guild.id]+"skipto") {
					embed_error(msg, "Unable to skip to song, invalid input, the syntax for the command is `-skipto {song index}`!")
					return false;
				} else if (msg.content.slice(0, 8) == prefix[msg.guild.id]+"skipto ") {
		...
		} else if (msg.content == prefix[msg.guild.id]+"disconnect") {
			// disconnect user
			disconnect(msg);
		
		// - np (now playing)
		} else if (msg.content == prefix[msg.guild.id]+"np") {
		...
		} else if (msg.content == prefix[msg.guild.id]+"ping") {
		...
		} else if (msg.content == prefix[msg.guild.id]+"queue") {
			// embed
		...
		} else if (msg.content.slice(0, 8) == prefix[msg.guild.id]+"remove ") {
		...
		} else if (msg.content == prefix[msg.guild.id]+"playtop" || msg.content == prefix[msg.guild.id]+"reverse") {
			// check if the queue is empty
			if (song_queus[msg.guild.id] == undefined) {
		...
		} else if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"move ") {
			// check if the queue is empty
			if (song_queus[msg.guild.id] == undefined) {
				embed_error(msg, "The queue is empty you can't reverse an empty queue!");
				return false;
		...
		} else if (msg.content == prefix[msg.guild.id]+"loop") {
			// toggle loop
		...
		} else if (msg.content == prefix[msg.guild.id]+"loopq") {
			// backup queue
		...
		} else if (msg.content == prefix[msg.guild.id]+"clearq") {
			song_queus[msg.guild.id] = [];
			embed_chat_reply(msg, "The song queue has been cleared by "+msg.member.user.tag+"!");
			
		} else if (msg.content == prefix[msg.guild.id]+"clear") {
			help_clear(msg);
			
		// - removedupes (removes duplicate songs from queue)
		} else if (msg.content == prefix[msg.guild.id]+"removedupes") {
			// check if the queue is empty
			if (song_queus[msg.guild.id] == undefined) {
		...
		} else if (msg.content == prefix[msg.guild.id]+"shuffle") {
			// check if queue is empty
			if (song_queus[msg.guild.id] == undefined) {
		...
		} else if (msg.content == prefix[msg.guild.id]+"replay") {
			// check if queue is empty
			if (song_queus[msg.guild.id] == undefined) {
		...
		} else if (msg.content == prefix[msg.guild.id]+"testaudio") {
		...
		} else if (msg.content == prefix[msg.guild.id]+"join") {
			// get users voice channel
			channel = msg.member.voice.channel;
			if (channel == undefined) {
				embed_error(msg, "Your not connected to any voice channel!");
		...
		} else if (msg.content == prefix[msg.guild.id]+"pause") {
			dj[msg.guild.id].pause();
			embed_info_reply(msg, "The song has been paused!");
		
		// - resume (resume paused music)
		} else if (msg.content == prefix[msg.guild.id]+"resume") {
		...
		} else if (msg.content == prefix[msg.guild.id]+"settings" || msg.content == prefix[msg.guild.id]+"songinfo" || msg.content == prefix[msg.guild.id]+"streaminfo") {
		...
		} else if (msg.content.slice(0, 10) == prefix[msg.guild.id]+"freeplay ") {
			command = msg.content.slice(10, msg.content.length);
			if (command == "on") {
				freeplay[msg.guild.id] = true;
...
bot.on("message", msg => {
	try {
		if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
			if (msg.content == prefix[msg.guild.id]+"globaldicts") {
				if (authorised_IDs.indexOf(msg.author.id) > -1) {
					output = "";
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 8) == prefix[msg.guild.id]+"isleap ") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 5) == prefix[msg.guild.id]+"bmi ") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"calc ") {
			// format the string
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 8) == prefix[msg.guild.id]+"saynum " || msg.content.slice(0, 10) == prefix[msg.guild.id]+"int2text ") {
			if (msg.content.slice(0, 10) == prefix[msg.guild.id]+"int2text ") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 5) == prefix[msg.guild.id]+"hash") {
			hash_help(msg);
		}
	}
})
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 5) == prefix[msg.guild.id]+"md4 ") {
			hash(msg, "md4");
		}
	}
})
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 5) == prefix[msg.guild.id]+"md5 ") {
			hash(msg, "md5");
		}
	}
})
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"sha1 ") {
			hash(msg, "sha1");
		}
	}
})
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 8) == prefix[msg.guild.id]+"sha224 ") {
			hash(msg, "sha224");
		}
	}
})
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 8) == prefix[msg.guild.id]+"sha256 ") {
			hash(msg, "sha256");
		}
	}
})
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 8) == prefix[msg.guild.id]+"sha384 ") {
			hash(msg, "sha384");
		}
	}
})
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 8) == prefix[msg.guild.id]+"sha512 ") {
			hash(msg, "sha512");
		}
	}
})
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"shift") {
			if (msg.content == prefix[msg.guild.id]+"shift") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 10) == prefix[msg.guild.id]+"addscore ") {
			if (msg.member.hasPermission("BAN_MEMBERS") == true) {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 6) == prefix[msg.guild.id]+"level" || msg.content.slice(0, 12) == prefix[msg.guild.id]+"leaderboard" || 
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (leaderboard_intervals[msg.guild.id] == undefined) {
			...
			if (msg.content != prefix[msg.guild.id]+"levels") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content.slice(0, 5) == prefix[msg.guild.id]+"rank") {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"restorebackup") {
			if (msg.member.hasPermission("MANAGE_CHANNELS") == true) {
				// get directory
				server_name = msg.guild.name.replace(" ","_")+"_"+ msg.guild.id;
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"welcome") {
			if (msg.member.hasPermission("MANAGE_CHANNELS") == true) {
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		if (msg.content == prefix[msg.guild.id]+"clearwelcome") {
			if (msg.member.hasPermission("MANAGE_CHANNELS") == true) {
				// clear file
...
bot.on("guildCreate", guild => {
	...
	embed_join.setDescription("Thanks for adding JaredBot to your server, the prefix for the bot is `"+prefix[msg.guild.id]+"`, "+
...
function weather_get_elem(html, index) {
	...
	function e(elms) {
		try {
			...
			current_elm = current_elm.replace("partially cloudy", "pc").replace("cloudy", "c").replace("clear", "cl").replace("Night", "N");
			current_elm = current_elm.replace("Low", "L").replace("None", "N").replace("Snow", "S").replace("snow showers", "SS");
			return current_elm;
		} catch {
			return "-";
		}
	...
	// return dict;
	return {
		"cloudy" : e([['<th class="b-forecast__table-header">', 1], ['<td class="b-forecast__table-weather-cell">', index], ['<img alt="', 1], ['" src', 0]]),
...
function weather_week_embed(msg, html) {
	...
	if (day1_p1["map"] != "https://-") {
		embed_weather.setThumbnail(day1_p1["map"]);
	}
	...
	for (x=0;x<6;x++) {
		...
		console.log([AM, PM, Night]);
		
		// current day data
		embed_weather.addField(AM["day"], "`    " + AM["am_pm"] + "\t" + PM["am_pm"] + "\t" + Night["am_pm"] + "\n" +
			"☁️: " + AM["cloudy"] + "\t" + PM["cloudy"] + "\t" + Night["cloudy"] + "\n" +
			"💨: " + AM["wind"] + "\t" + PM["wind"] + "\t" + Night["wind"] + "\n" +
			"🌧️: " + AM["rain"] + "\t" + PM["rain"] + "\t" + Night["rain"] + "\n" +
			"❄️: " + AM["snow"] + "\t" + PM["snow"] + "\t" + Night["snow"] + "\n" +
			"🌡️: " + AM["temp_high"] + "\t" + PM["temp_high"] + "\t" + Night["temp_high"] + "\n" +
			"🧊: " + AM["temp_low"] + "\t" + PM["temp_low"] + "\t" + Night["temp_low"] + "\n" +
			"🌨️: " + AM["chill"] + "\t" + PM["chill"] + "\t" + Night["chill"] + "\n" +
			"💧: " + AM["uv"] + "\t" + PM["uv"] + "\t" + Night["uv"] + "`\n\u200B", 
		true);
	}
...
bot.on("message", msg => {
	if (msg.guild != null && authrosied_server_IDs.indexOf(msg.guild.id) > -1) {
		console.log([msg.content.slice(0, 9), prefix[msg.guild.id]+"weather "])
		if (msg.content.slice(0, 9) == prefix[msg.guild.id]+"weather ") {
			// URL
			command = msg.content.slice(9, msg.content.length).replace(/ /g, "-");
